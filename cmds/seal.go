...
type SealCommand struct {
	...
	Deposit                  DepositCommand                             `cmd:"" name:"deposit-pool" help:"deposit feefi pool"`
	PoolRegister             PoolRegisterCommand                        `cmd:"" name:"pool-register" help:"register feefi pool"`
	PoolPolicyUpdaterCommand PoolPolicyUpdaterCommand                   `cmd:"" name:"pool-policy-updater" help:"update feefi pool policy"`
...
func NewSealCommand() SealCommand {
	return SealCommand{
		...
		PoolPolicyUpdaterCommand: NewPoolPolicyUpdaterCommand(),
