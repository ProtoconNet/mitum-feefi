...
var (
	GenesisCurrenciesFactType   = hint.Type("mitum-feefi-genesis-currencies-operation-fact")
	...
	GenesisCurrenciesType       = hint.Type("mitum-feefi-genesis-currencies-operation")
...
type GenesisCurrenciesFact struct {
	...
	cs             []extensioncurrency.CurrencyDesign
}
...
func (fact GenesisCurrenciesFact) Currencies() []extensioncurrency.CurrencyDesign {
	return fact.cs
}
